...
from data_utils.joint_entity_aware_mhs_utils import SpaceEvalConfig1DataProcessor_1, SpaceEvalConfig1DataProcessor_2
from data_utils.mhs_utils import processors
from data_utils.msprl.mhs import SpRLMHSDataProcessTask1, SpRLMHSDataProcessTask2, SpRLMHSDataProcessTask3_1, \
    SpRLMHSDataProcessTask3_2
from model.mhs import Config1Model1, Config1Model2, EATransformerMHS, Config3BModel1, Config3BModel2Softmax
from model.sprl.mhs import SpRLModel_B, JointSpRLModel_B
...
MODEL_CLASSES = {
    ...
    # "task_3_pipeline_1": (BertEncoder, Config3BModel1, BertTokenizer, SpRLMHSDataProcessTask3_1, "pipeline"),
    "task_3_pipeline": (BertEncoder, SpRLModel_B, BertTokenizer, SpRLMHSDataProcessTask3_2),
    ...
    # "task_3_joint": (BertEncoder, EATransformerMHS, BertTokenizer, SpRLMHSDataProcessTask3_1, "joint"),
    "task_3_joint": (BertEncoder, JointSpRLModel_B, BertTokenizer, SpRLMHSDataProcessTask3_2),
}


def get_train_inputs(args, input_tuple, features_num):
    pass


def get_test_parameters(args, input_tuple):
    pass
...
def train(args, train_dataset, model, tokenizer, processor, eval_dataset=None):
    ...
    for epoch in range(int(args.num_train_epochs)):
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if not args.model_type.endswith("pipeline"):
    ...
    for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
        ...
        for batch in tqdm(eval_dataloader, desc="Evaluating", mininterval=5):
            ...
            with torch.no_grad():
                ...
                if args.model_type.endswith("joint"):
                    inputs["token_to_pre_idx"] = batch[-1]
