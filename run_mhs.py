...
MODEL_CLASSES = {
    'bert': (BertConfig, BertMultiHeadSelection, BertTokenizer),
    'bert_v2': (BertConfig, MultiHeadSelection, BertTokenizer),
    'transformer': (BertConfig, TransformerMultiHeadSelection, BertTokenizer),
...
def main():
    ...
    config.__dict__.update({"labels": processor.get_labels(), "relations": processor.get_relations()})
    if args.config_dir:
        config.__dict__.update(json.load(open(args.config_dir)))
