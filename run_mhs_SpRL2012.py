...
from data_utils.sprl.mhs import SpRLMHSDataProcessTask1, SpRLMHSDataProcessTask2, SpRLMHSDataProcessTask1_softmax, SpRLMHSDataProcessTask2_softmax
from model.mhs import EATransformerMHS, EATransformerMHSSoftmax
from model.sprl.mhs import SpRLModel_B, SpRLModel_B_softmax, JointSpRLModel_B, JointSpRLModel_B_softmax
...
class SpRLMHSDataProcessTask2__softmax(object):
    pass
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    ...
                    if args.local_rank == -1 and args.evaluate_during_training:
                        results = evaluate(args, model, tokenizer, processor, prefix=global_step, dataset=eval_dataset, save_predict=False)
    ...
    for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
        ...
        for batch in tqdm(eval_dataloader, desc="Evaluating", mininterval=5):
            ...
            with torch.no_grad():
                ...
                if args.model_type.__contains__("joint"):
