...
from data_utils.entity_aware_mhs_utils import EntityAwareMHSDataProcessor, EntityAwareMHSDataProcessor_2
from data_utils.mhs_utils import processors
from model.mhs_transformer import EATransformerMHS
...
def evaluate(args, model, tokenizer, processor, prefix="", dataset=None, save_predict=True):
    ...
    for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
        eval_dataset = dataset if dataset is not None else load_and_cache_examples(args, processor, tokenizer, evaluate=True)
